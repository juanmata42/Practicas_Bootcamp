let puntuaciones=[{nombre:"GamerGranny",puntuacion:80},
...
{
	cartonPlayer=[{B:cartonArray[0],I:cartonArray[1],N:cartonArray[2],G:cartonArray[3],O:cartonArray[4]},{B:cartonArray[5],I:cartonArray[6],N:cartonArray[7],G:cartonArray[8],O:cartonArray[9]},{B:cartonArray[10],I:cartonArray[11],N:cartonArray[12],G:cartonArray[13],O:cartonArray[14]}]
	console.clear()
...
function lineacheck()
{
	...
	if (lineas[0]===1&&linea1.every(i => i === "X"))
	{
		alert("Linea!")
		lineas[0]=0
	}
	else if (lineas[1]===1&&linea2.every(i => i === "X"))
	{
		alert("Linea!")
		lineas[1]=0
	}
	else if (lineas[2]===1&&linea3.every(i => i === "X"))
	{
		alert("Linea!")
		lineas[2]=0
	}
...
function bingo()
{
	puntuaciones=[{nombre:"GamerGranny",puntuacion:80},
						{nombre:"AdolfoNumber1",puntuacion:34},
						{nombre:"ASS",puntuacion:69},
						{nombre:"Güiner",puntuacion:1},
						{nombre:"Respuesta",puntuacion:42}]
