...
function falloRisas() {
    ...
    setTimeout(() => {
        document.getElementById("risas").style.display = "none";
    }, 1000);
}
...
function answering() {
    event.preventDefault();
    respuesta = eliminarDiacriticosEs(
...
function finDelJuego() {
    ...
    for (let i = 0; i < puntuaciones.length; i++) {
        document.getElementById(
            i
        ).innerText = `${puntuaciones[i].nombre} ${puntuaciones[i].puntuacion}`;
    }
...
function timedCount() {
    ...
    if (tiempo === 0) {
        ...
        segundo = setTimeout(timedCount, 1000);
    }
}
...
const questions = [
...

    {
        ...
        question: "CON LA J. Nombre abreviado del creador de este programa.",
    },
